...
The intent of projects is to build something using technologies you have been taught, as well as to learn new technologies on your own.

This rubric serves to guide students and mentors in the requirements. Wherever there is ambiguity on what the requirements are, focus on the goal of learning. One 

## Projects

* NoDB
* Personal
* Group (group projects have minimal technical requirements)
